{
  description = "Jane Street's Incremental, but ported to F#";
    ...
    in {
      ...
      in {
        ...
        default = pkgs.buildDotnetModule {
          ...
          disabledTests = ["WoofWare.Incremental.Test.TestSurface.CheckVersionAgainstRemote"];
